...
if (!isset($_SESSION['login_admin']) || !isset($produit)) {
...
<div class="admin-container">
    ...
    <aside class="admin-sidebar">
        ...
        <ul>
            ...
            <li><a href="indexAdmin.php?controleur=admin&action=afficherTousLesProduits" class="active">📦 Produits</a></li>
            <li><a href="indexAdmin.php?controleur=admin&action=afficherCommandes">🛒 Commandes</a></li>
            <li><a href="indexAdmin.php?controleur=admin&action=afficherUtilisateurs">👥 Utilisateurs</a></li>
    ...
    <main class="admin-main">
        ...
        <div class="admin-form-container">
            <div class="form-header">
                <h2>Modifier le Produit #<?php echo (int)$produit->id; ?></h2>
                <a href="indexAdmin.php?controleur=admin&action=afficherTousLesProduits" class="btn-admin btn-admin-secondary">← Retour à la liste</a>
            </div>
            ...
            <?php if (isset($messages['succes'])): ?>
                ...
                <script>
                    setTimeout(function() {
                        window.location.href = 'indexAdmin.php?controleur=admin&action=afficherTousLesProduits';
                    }, 2000);
                </script>
            <?php endif; ?>
            ...
            <!-- Formulaire -->
            <form method="POST" action="indexAdmin.php?controleur=admin&action=editerProduit&id=<?php echo (int)$produit->id; ?>" enctype="multipart/form-data" class="admin-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nom" name="nom" required maxlength="50" 
                           value="<?php echo htmlspecialchars($produit->nom, ENT_QUOTES, 'UTF-8'); ?>"
                           placeholder="Ex: Miles Davis - Live At Montreux">
                </div>

                <div class="form-group">
                    <label for="description">Description *</label>
                    <textarea id="description" name="description" required rows="5" maxlength="500" 
                              placeholder="Décrivez le produit..."><?php echo htmlspecialchars($produit->description, ENT_QUOTES, 'UTF-8'); ?></textarea>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="prix" name="prix" required step="0.01" min="0" 
                               value="<?php echo number_format((float)$produit->prix, 2, '.', ''); ?>"
                               placeholder="0.00">
                    </div>
                            ...
                            <?php if (isset($categories) && !empty($categories)): ?>
                                <?php foreach ($categories as $categorie): ?>
                                    <option value="<?php echo (int)$categorie->id; ?>" 
                                            <?php echo ((int)$categorie->id === (int)$produit->idCategorie) ? 'selected' : ''; ?>>
                ...
                <?php if (!empty($produit->image)): ?>
                    <div class="form-group">
                        ...
                        <div class="current-image">
                            ...
                            <p><em><?php echo htmlspecialchars($produit->image, ENT_QUOTES, 'UTF-8'); ?></em></p>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-admin btn-admin-success">✓ Enregistrer les modifications</button>
                    <a href="indexAdmin.php?controleur=admin&action=afficherTousLesProduits" class="btn-admin btn-admin-secondary">Annuler</a>
                </div>
            </form>
        </div>
    </main>
        ...
        if (file && file.type.startsWith('image/')) {
            ...
            reader.onload = function(e) {
                ...
                if (!preview) {
                    ...
                    preview.innerHTML = '<h3>Aperçu de la nouvelle image:</h3><img id="previewImg" src="" alt="Aperçu">';
